  ...
  return (
    <div className="mt-[100px] flex flex-col items-center justify-center sm:mt-[250px]">
      <div className="relative flex flex-col items-center justify-center gap-5 text-center">
        ...
        <Button variant="secondary" size="lg" className="mt-6 bg-black text-white hover:bg-black/75">
          데모요청하기
        </Button>
      </div>
      <Image
      ...
      />
      <Image src="/assets/landing/hero-img.png" alt="hero" width={720} height={724} className="mt-[100px]" />
      <div className="mt-[150px] flex flex-col items-center justify-center gap-12 max-sm:text-center">
        <h2 className="text-[24px] font-bold sm:text-[44px]">전 세계 수백만 명이 매일 사용하는 GLIMPSE</h2>
        <div className="flex items-center gap-10 max-sm:w-screen">
          <Image src="/assets/landing/s01.png" alt="s01" width={110} height={33} />
          <Image src="/assets/landing/s02.png" alt="s02" width={110} height={33} />
          <Image src="/assets/landing/s03.png" alt="s03" width={110} height={33} />
        </div>
      </div>
    </div>
  );
